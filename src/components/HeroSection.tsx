    ...
    <section className="relative min-h-screen flex items-center justify-center particle-bg overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          ...
          {/* Subheadline */}
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto animate-slide-up delay-200">
      ...
      {/* Floating Elements */}
      <div className="absolute top-20 left-10 glass-card p-4 floating delay-100 hidden lg:block">
        <div className="w-8 h-8 bg-neon-green rounded-lg mb-2"></div>
        <p className="text-xs text-gray-300">+12% this week</p>
      </div>

      <div className="absolute bottom-32 right-10 glass-card p-4 floating delay-200 hidden lg:block">
      ...
      <div className="absolute top-1/2 left-5 glass-card p-3 floating delay-400 hidden lg:block">
